...
const modern_locales = [_][]const u8{
    ...
    "ar-EG",
    // Region variant: en-IN uses Indian digit grouping ("#,##,##0" — a 3-digit
    // primary group then 2-digit secondary groups: 1,00,000), packed so it
    // resolves its own decimal pattern instead of falling back to en's "#,##0".
    "en-IN",
};
