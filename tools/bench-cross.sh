...
emit() {
  ...
  echo
  echo "Subprocess wall-clock, median of $RUNS runs after $WARMUP discarded"
  echo "warmup. Times in **ms**. \`*\` flags a fixture whose max-min spread"
  echo "exceeded ${SPREAD_LIMIT}% — treat that cell as noisy."
  echo
