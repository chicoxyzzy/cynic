...
╚══════════════════════════════════════════════════════════════════════╝
  ...
  ──────────────────
   ...
   └────┬─────────────┘
        ...
        ▼
   ┌──────────────────┐
   │  Ohaimark (T2)   │  ◄── SSA front end; codegen future (M6)
   └──────────────────┘
...
opts out) and Ohaimark (feedback/SSA front end landed; optimized execution
future) consume bytecode + warmth/IC data, not the AST. Ohaimark's accepted
design and GC-pointer-free feedback boundary are in
