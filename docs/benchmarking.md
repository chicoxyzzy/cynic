...
| `loose_eq_bigint_string` | 125,000 × 2 orders | Mixed BigInt/String `==` execution in both operand orders. Pins §7.2.13 StringToBigInt parsing through the interpreter's OOM-aware allocating path without object coercion. |
