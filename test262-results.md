...
**Cynic passes 90.77 % of the 49808 test262 fixtures it runs**, scored binary pass/fail under a single posture (`--unhardened --allow=eval`):

- **45212 passing** — Cynic produced the spec-expected result.
...
|---|---:|---:|---:|---:|
| **`--unhardened --allow=eval`** | 45212 | 4596 | 49808 | 90.77 % |
...
| **engine gaps** | 127 | failures the policy classes do not explain — the work list (an upper bound: it includes a residue of fixtures whose sloppy semantics hide inside dynamic `Function(...)` bodies, undetectable from frontmatter) |
...
| `language/expressions` | 10271 | 411 | 33 | 96 % |
...
### 2026-06-10 — cynic `3f09bb1`, test262 `d0c1b4555b`

| passing | failing | total | pass% | Δ pass | elapsed |
|---:|---:|---:|---:|---:|---:|
| 45212 | 4596 | 49808 | 90.77 % | +46 | 35.1 s |
