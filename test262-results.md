...
| **runtime** | 33.92 % | 45.72 % | 17514 / 51639 |
...
|---|---:|---:|---:|---:|---:|
| `language/expressions` | 3909 | 6158 | 971 | 35 % | 39 % |
| `language/statements` | 2716 | 5954 | 667 | 29 % | 31 % |
| `built-ins/RegExp` | 649 | 1069 | 161 | 35 % | 38 % |
| `built-ins/Array` | 1856 | 1014 | 211 | 60 % | 65 % |
| `built-ins/Object` | 2378 | 948 | 85 | 70 % | 71 % |
| `built-ins/TypedArray` | 390 | 832 | 216 | 27 % | 32 % |
| `built-ins/String` | 588 | 630 | 5 | 48 % | 48 % |
| `built-ins/TypedArrayConstructors` | 277 | 435 | 24 | 38 % | 39 % |
| `built-ins/Promise` | 251 | 423 | 3 | 37 % | 37 % |
| `built-ins/Iterator` | 113 | 391 | 6 | 22 % | 22 % |
| `built-ins/Function` | 144 | 276 | 89 | 28 % | 34 % |
| `built-ins/DataView` | 238 | 251 | 72 | 42 % | 49 % |
| `built-ins/Proxy` | 68 | 231 | 12 | 22 % | 23 % |
| `language/module-code` | 380 | 202 | 14 | 64 % | 65 % |
| `built-ins/Date` | 417 | 169 | 8 | 70 % | 71 % |
| `language/arguments-object` | 80 | 126 | 57 | 30 % | 39 % |
| `language/eval-code` | 10 | 117 | 220 | 3 % | 8 % |
| `built-ins/JSON` | 40 | 103 | 22 | 24 % | 28 % |
| `built-ins/Set` | 293 | 89 | 1 | 77 % | 77 % |
| `language/literals` | 358 | 79 | 97 | 67 % | 82 % |
| `built-ins/Number` | 265 | 75 | 0 | 78 % | 78 % |
| `built-ins/Map` | 140 | 63 | 1 | 69 % | 69 % |
| `built-ins/Reflect` | 91 | 62 | 0 | 59 % | 59 % |
| `language/statementList` | 27 | 53 | 0 | 34 % | 34 % |
| `built-ins/ArrayBuffer` | 32 | 52 | 112 | 16 % | 38 % |
| `built-ins/Symbol` | 39 | 51 | 8 | 40 % | 43 % |
| `built-ins/NativeErrors` | 45 | 49 | 0 | 48 % | 48 % |
| `built-ins/FinalizationRegistry` | 0 | 47 | 0 | 0 % | 0 % |
| `built-ins/parseFloat` | 12 | 42 | 0 | 22 % | 22 % |
| `language/computed-property-names` | 6 | 42 | 0 | 13 % | 13 % |
| `built-ins/Error` | 17 | 41 | 0 | 29 % | 29 % |
...
| `built-ins/parseInt` | 26 | 29 | 0 | 47 % | 47 % |
...
| `language/reserved-words` | 23 | 4 | 0 | 85 % | 85 % |
...
| **runtime** | 33.92 % | 45.72 % | 17514 / 51639 | n/a |
