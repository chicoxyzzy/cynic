...
| **runtime** | 41.07 % | 55.37 % | 21210 / 51639 |
...
### 2026-05-09 — cynic `9f7e12f`, test262 `d0c1b455`

|         | spec% | attempted% | pass / total | Δ pass |
|---|---|---|---|---:|
| **runtime** | 41.07 % | 55.37 % | 21210 / 51639 | +3345 |

Biggest movers (runtime):

- `built-ins/Iterator` +88
- `built-ins/Proxy` +48
- `built-ins/JSON` +30
- `built-ins/Array` +17
- `built-ins/String` +16
